...
> **Quick links:** [Patterns](../development/Patterns.md) · [Syntax](../development/Syntax.md) · [API Contracts](../api/ApiContracts.md) · [Runbook](../operations/Runbook.md) · [Task & Roadmap](../planning/Task.md)
